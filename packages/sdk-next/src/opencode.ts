import { OpenCode } from "@kxen/client/effect"
...
import { createEmbeddedRoutes } from "@kxen/server/routes"
...
export class Service extends Context.Service<Service, Interface>()("@kxen/sdk-next/OpenCode") {}
