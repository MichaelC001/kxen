...
export const TypeId: TypeId = "~@kxen/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@kxen/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@kxen/effect-sqlite-node/NodeSqliteClient")
