...
beforeAll(async () => {
  ...
  mock.module("@kxen/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@kxen/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@kxen/ui/icon", () => ({ Icon: () => null }))
  mock.module("@kxen/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
