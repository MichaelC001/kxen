...
import type { Data, Definition, Payload } from "@kxen/schema/event"
...
import { Durable } from "@kxen/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@kxen/schema/event").ID
export type { Data, Definition, Payload } from "@kxen/schema/event"
