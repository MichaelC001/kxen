...
import { llmClient } from "@kxen/core/effect/app-node-platform"
...
import type { LLMEvent } from "@kxen/llm"
import { LLMClient } from "@kxen/llm/route"
import type { LLMClientService } from "@kxen/llm/route"
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // Runtime seam: native is an opt-in adapter over @kxen/llm. It
