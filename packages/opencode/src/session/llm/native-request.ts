import type { JsonSchema, LLMRequest, ProviderMetadata } from "@kxen/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@kxen/llm"
import { AmazonBedrock, Anthropic, Azure, Google, OpenAI, OpenAICompatible, OpenRouter } from "@kxen/llm/providers"
...
export const request = (input: RequestInput) => {
  ...
  // @kxen/llm request objects from opencode's session/AI SDK-shaped data.
  return LLM.request({
