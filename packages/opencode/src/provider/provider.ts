...
import os from "os"
import { ConfigV1 } from "@kxen/core/v1/config/config"
import fuzzysort from "fuzzysort"
import { Config } from "@/config/config"
import { mapValues, mergeDeep, omit, pickBy, sortBy } from "remeda"
import { NoSuchModelError, type Provider as SDK } from "ai"
import { Npm } from "@kxen/core/npm"
import { Hash } from "@kxen/core/util/hash"
...
const BUNDLED_PROVIDERS: Record<string, () => Promise<(opts: any) => BundledSDK>> = {
  ...
  "@ai-sdk/github-copilot": () =>
    import("@kxen/core/github-copilot/copilot-provider").then((m) => m.createOpenaiCompatible),
...
const priority = ["claude-sonnet-4-5", "gpt-5", "grok-build", "k3", "kimi-for-coding", "claude-sonnet-4", "big-pickle", "gemini-3-pro"]
