...
SolidJS UI
    |
WebSocket RPC 和 Stream
    |
Rust AppState
    |
Session、Agent、MRM、Tools、Knowledge、MCP、LSP
    |
本地文件、进程、Provider 和系统能力
```
...
当前 Runtime 只支持 macOS 14 及以上版本和 Apple Silicon。Tauri bundle 目标是 DMG，签名身份尚未配置。
