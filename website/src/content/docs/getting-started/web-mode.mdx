...
Windows 和自定义版本、目录、PATH 的命令见 [CLI 安装](https://kxen.ai/getting-started/cli-installation)。安装后启动：
...
| `--token <TOKEN>`     | 每次随机  | 固定非空 token 便于把 URL 书签化；任意字符会自动 URL 编码 |
