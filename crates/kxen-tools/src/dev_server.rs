...
async fn wait_ready(task: Arc<crate::task::TaskHandle>, pattern: Option<String>, port: Option<u16>) -> Option<String> {
...
fn spawn_health_check(task: Arc<crate::task::TaskHandle>, registry: Arc<TaskRegistry>) {
