...
use kxen_core::auth::credential::AuthStore;
use kxen_core::auth::refresh::RefreshOutcome;
...
pub(super) async fn refresh(
    ...
    let request = kxen_core::auth::refresh::ensure_fresh(store, &model.provider, model.account.as_deref());
