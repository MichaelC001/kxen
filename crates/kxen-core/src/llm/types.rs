...
pub struct Message {
    pub role: Role,
    pub content: crate::core::shared::SharedText,
    ...
    pub tool_call_id: Option<crate::core::shared::SharedText>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<crate::core::shared::SharedText>,
}

/// 图片（全链路只 base64，不落盘明文；Kimi 不收公网 URL 因此不做 URL 分支）。
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct ImagePart {
    pub media_type: crate::core::shared::SharedText,
    pub data: crate::core::shared::SharedText,
}
...
pub struct FunctionCall {
    pub name: crate::core::shared::SharedText,
    pub arguments: crate::core::shared::SharedText,
}

impl AssistantToolCall {
    pub fn function(
        id: impl Into<String>,
        name: impl Into<crate::core::shared::SharedText>,
        arguments: impl Into<crate::core::shared::SharedText>,
    ) -> Self {
...
impl Message {
    pub fn system(content: impl Into<crate::core::shared::SharedText>) -> Self {
        Self { role: Role::System, content: content.into(), images: vec![], tool_calls: vec![], tool_call_id: None, name: None }
    }
    pub fn user(content: impl Into<crate::core::shared::SharedText>) -> Self {
        Self { role: Role::User, content: content.into(), images: vec![], tool_calls: vec![], tool_call_id: None, name: None }
    }
    pub fn user_with_images(content: impl Into<crate::core::shared::SharedText>, images: Vec<ImagePart>) -> Self {
        Self { role: Role::User, content: content.into(), images, tool_calls: vec![], tool_call_id: None, name: None }
    }
    pub fn assistant(content: impl Into<crate::core::shared::SharedText>) -> Self {
        Self { role: Role::Assistant, content: content.into(), images: vec![], tool_calls: vec![], tool_call_id: None, name: None }
    }
    pub fn assistant_with_tools(content: impl Into<crate::core::shared::SharedText>, tool_calls: Vec<AssistantToolCall>) -> Self {
        Self { role: Role::Assistant, content: content.into(), images: vec![], tool_calls, tool_call_id: None, name: None }
    }
    pub fn tool_result(
        id: impl Into<crate::core::shared::SharedText>,
        name: impl Into<crate::core::shared::SharedText>,
        content: impl Into<crate::core::shared::SharedText>,
    ) -> Self {
        Self {
            role: Role::Tool,
