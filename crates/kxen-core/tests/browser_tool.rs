...
use kxen_core::agent::agent_loop::SessionExtrasRegistry;
use kxen_core::tools::browser::driver::RawAxNode;
use kxen_core::tools::browser::fake::FakeDriver;
use kxen_core::tools::browser::{BrowserSlot, dispatch};
use serde_json::json;
...
fn screenshot_writes_file_under_session_dir() {
    rt().block_on(async {
        ...
        kxen_core::core::session::remove(&dir, "ses_shot");
