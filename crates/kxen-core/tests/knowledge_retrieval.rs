...
use kxen_core::core::config::{Config, EmbeddingConfig};
use kxen_core::knowledge::embedding::{self, Protocol};
use kxen_core::knowledge::embedding_cache::{CACHE_MAX, EmbeddingCache};
use kxen_core::knowledge::retrieval::{self, fuse};
use kxen_core::knowledge::{Entry, Kind, Scope};
