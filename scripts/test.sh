...
sleep 4
pnpm exec vitest run src/components/orb.test src/components/selection.test src/components/AgentFocusView.test src/components/RightColumn.test src/components/Dock.test src/components/DockWorktree.test src/components/NotificationCenter.test src/components/StatusBar.test
sleep 4
